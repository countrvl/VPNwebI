...
import PersonalAreaAdmin from './components/PersonalAreaAdmin/PersonalAreaAdmin';
    ...
    <>
      ...
      <div className="container py-5">
        <Routes>
          ...
          <Route path="/personalarea" element={<PrivateRoute><PersonalAreaAdmin /></PrivateRoute>} />
